...
df = pd.read_csv(r"OCO_global_final_SIFtotal2.csv")
...
joblib.dump(lgbm, 'OCO_lgbm_total2.pkl')
lgbm = joblib.load(r"OCO_lgbm_total2.pkl")
...
plt.plot([0, 22], [0, 22], '--', color='black')
...
plt.yticks(np.arange(0, 22, 5), fontsize=14)
plt.clim(0, 3)
plt.gca().set_aspect('equal')
plt.tight_layout()
plt.savefig(fr'SIFtotal2.png', dpi=300)
plt.show()
